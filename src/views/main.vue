<template>
  <div class="main">
      ...
      <div class="right" v-else>
        ...
        <el-dropdown @command="quit">
          <span class="el-dropdown-link">
            <span>{{uname}}</span><i class="el-icon-arrow-down el-icon--right"></i>
          </span>
    ...
    <div class="fix-right">
      ...
      <div>152 0920 8488</div>
      <div class="wechat">
        <img src="../../static/img/weichat.png" alt="" />
        <span>微信</span>
      </div>
      <div style="width: 116px; height: 116px; margin-bottom: 8px">
        <img style="width: 100%" src="../../static/img/qrcode@2x.png" alt="" />
      </div>
      <div class="heng"></div>
      <div class="bottom">工作时间：每周一到周五 9:30-18:30</div>
    </div>
  </div>
</template>
<script>
export default {
  ...
  mounted() {
    ...
    this.axios.get(`/users/${id}`).then(res=>{
      this.uname=res.data.major_name.slice(0,1)
    })
  ...
  methods: {
    ...
    quit(){
      ...
      console.log(this.$store.state.isLogin,sessionStorage.getItem('isLogin'))
    }
  },
  watch: {
    value() {
...
.main .fix-right > div:first-child {
  font-size: 18px;
  font-weight: 600;
  text-align: left;
...
.main .fix-right .qq,
.main .fix-right .phone,
.main .fix-right .wechat {
  display: flex;
  align-items: center;
  margin-bottom: 4px;
}
.main .fix-right .qq img,
.main .fix-right .wechat img,
.main .fix-right .phone img {
  width: 16px;
  height: 16px;
  margin-right: 4px;
}
.main .fix-right .qq span,
.main .fix-right .phone span,
.main .fix-right .wechat span {
  font-size: 14px;
  font-weight: 400;
  color: rgba(0, 0, 0, 0.7);
  line-height: 20px;
}
.main .fix-right .qq + div,
.main .fix-right .phone + div {
  font-size: 14px;
  font-weight: 400;
  color: rgba(0, 0, 0, 0.7);
  line-height: 20px;
...
.main .top .right > div:nth-child(2)>span>span{
  background: #2886ff;
